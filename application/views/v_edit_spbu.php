    ...
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <?php
                ...
                echo form_open('spbu/edit/'.$spbu->id_spbu);
                ?>
            <div class="card-body">     
                <div class="row mb-4">
                <!-- kolom form input -->
                    <div class="col-lg-5 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" name="nama_spbu" placeholder="ex:SPBU lorem ipsum km..." value="<?= $spbu->nama_spbu ?>">
                            <small class="form-text text-muted">silahkan mengisi nama SPBU</small>
                        </div>
                        <!-- Form Alamat -->
                        <div class="mb-4">
                            <label>Alamat</label>
                            <input class="form-control" name="alamat" placeholder="ex:Jl siratal mustaqim" value="<?= $spbu->alamat ?>" >
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" name="penyedia">
                                <option value="<?= $spbu->penyedia ?>">Pilih penyedia SPBU :</option>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="latitude" id="latitude" placeholder="0.00000"    value="<?= $spbu->latitude ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group">
                                        <label>Longitude</label>
                                        <input class="form-control" name="longitude" id="longitude" placeholder="0.00000"    value="<?= $spbu->longitude ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <option value="<?= $spbu->kecamatan ?>">Pilih kecamatan :</option>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="wilayah" class="form-control">
                                <option value="<?= $spbu->wilayah ?>">Pilih wilayah SPBU :</option>
                        ...
                        <div class="my-4">
                            ...
                            <textarea name="keterangan" placeholder="Enter your message..." value="<?= $spbu->keterangan ?>" class="form-control" rows="4"></textarea>
                        </div>
                        <!-- tombol submit-->
...
<script>
    var mymap = L.map('map').setView([<?= $spbu->latitude ?>, <?= $spbu->longitude ?>], 14);
...
var curLocation =[<?= $spbu->latitude ?>, <?= $spbu->longitude ?>];
