            ...
            <div class="form-group mb-4">
                <label>Nama User</label>
                    <div class="input-group">
                        ...
                        <input name="nama_user" value="<?= $user->nama_user ?>" class="form-control" placeholder="walter white">
                    </div>  
            </div>
            <!-- End of Form -->
            <!-- Form username-->
            <div class="form-group mb-4">
                <label>Username</label>
                    <div class="input-group">
                        ...
                        <input name="username" value="<?= $user->username ?>" class="form-control" placeholder="heisenberg" >
                    </div>  
            </div>
            <!-- End of Form -->
                    ...
                    <label for="password">Your Password</label>
                        <div class="input-group">
                            <span class="input-group-text">
                                ...
                                <input name="password" value="<?= $user->username ?>" type="password" placeholder="Password" class="form-control" id="password">
                        </div>  
            </div>
            <!-- End of Form -->
            </div>
