...
//PETA INTERAKSI SPASIAL
    //KANTOR KECAMATAN
        ...
        <?php } ?>
    /*Itensitas kendaraan Blimbing
        var itensitasblimbing=L.layerGroup();
        var interlowok=[[-7.930173743398412,112.65189535303317],[-7.945861330285805,112.63052716330117]]; 
        var intersingo=[[-7.930173743398412,112.65189535303317],[-7.893861286766666,112.66293458186821]];
        var intersukun=[[-7.930173743398412,112.65189535303317],[-8.00487665693767,112.61858148186926]];
        var interkedun=[[-7.930173743398412,112.65189535303317],[-8.011652239541558,112.64381772603932]];
        var interpakis=[[-7.930173743398412,112.65189535303317],[-7.958967133543515,112.71686035488077]];
        var interkloje=[[-7.930173743398412,112.65189535303317],[-7.96569125625155,112.61804947241214]];
        var interlawan=[[-7.930173743398412,112.65189535303317],[-7.836316385585332,112.69707227892864]];
        var interkaran=[[-7.930173743398412,112.65189535303317],[-7.891395958587032,112.59440191255075]];
        var interdau  =[[-7.930173743398412,112.65189535303317],[-7.914074954750221,112.58596379905701]];
        var interjabun=[[-7.930173743398412,112.65189535303317],[-7.944972206510775,112.73413126837467]];

        var interwagir=[[-7.930173743398412,112.65189535303317],[-8.008769482952703,112.57244276837524]];
        var interpakji=[[-7.930173743398412,112.65189535303317],[-8.060928514826793,112.60164855488179]];
        var interbatu =[[-7.930173743398412,112.65189535303317],[-7.87991707863725,112.52867179720941]];
        var intertumpa=[[-7.930173743398412,112.65189535303317],[-8.002230755697871,112.76164637022251]];
        var interponco=[[-7.930173743398412,112.65189535303317],[-8.042102441254215,112.77287464138747]];
        var interjunre=[[-7.930173743398412,112.65189535303317],[-7.91055557931054,112.55761445488028]];
        var interpanje=[[-7.930173743398412,112.65189535303317],[-8.12987657899868,112.56622318371782]];
        var interbulul=[[-7.930173743398412,112.65189535303317],[-8.077694427829869,112.64098160379154]];
        var interturen=[[-7.930173743398412,112.65189535303317],[-8.169575025723118,112.68943669310302]];
        var interdampi=[[-7.930173743398412,112.65189535303317],[-8.211428328973343,112.74854853954203]];

        var interbumia=[[-7.930173743398412,112.65189535303317],[-7.838044440202887,112.52769552809151]];
        var interpujon=[[-7.930173743398412,112.65189535303317],[-7.849224913003989,112.48033478371494]];
        var interwajak=[[-7.930173743398412,112.65189535303317],[-8.102253081115615,112.73016845488225]];
        var intergonda=[[-7.930173743398412,112.65189535303317],[-8.17606693802475,112.63566388371831]];
        var intertajin=[[-7.930173743398412,112.65189535303317],[-8.049271228635726,112.68162180563698]];
        var interpagel=[[-7.930173743398412,112.65189535303317],[-8.195850066757924,112.61975679905969]];
        var intersumbe=[[-7.930173743398412,112.65189535303317],[-8.278716388656624,112.69003608686435]];
        var interngaju=[[-7.930173743398412,112.65189535303317],[-8.096319878145657,112.54093117022342]];
        var interpucun=[[-7.930173743398412,112.65189535303317],[-8.156563127210354,112.4741116413887]];
        var interbantu=[[-7.930173743398412,112.65189535303317],[-8.316174958375807,112.58031377866625]];
        var interngant=[[-7.930173743398412,112.65189535303317],[-7.84655732346883,112.37190926329482]];
        var interkalip=[[-7.930173743398412,112.65189535303317],[-8.205203370998408,112.4657687683773]];
        var intertirto=[[-7.930173743398412,112.65189535303317],[-8.226857480300573,112.83293284613062]];
        var intergedan=[[-7.930173743398412,112.65189535303317],[-8.292802294407691,112.64822312789612]];
        var interwonos=[[-7.930173743398412,112.65189535303317],[-8.033054305286328,112.49776268371676]];
        var interkrome=[[-7.930173743398412,112.65189535303317],[-8.130200469153094,112.48998965303534]];
        var interpagak=[[-7.930173743398412,112.65189535303317],[-8.225327995508875,112.52579524138947]];
        var interdonom=[[-7.930173743398412,112.65189535303317],[-8.285206920962832,112.4279539786642]];
        var interampel=[[-7.930173743398412,112.65189535303317],[-8.234095147669102,112.87767672789555]];
        var interkasem=[[-7.930173743398412,112.65189535303317],[-7.783746624542625,112.31114942789091]];
        ...
        var path1 = new L.Polyline.AntPath(interlowok,options1);   
        var path2 = new L.Polyline.AntPath(intersingo,options2);
        var path3 = new L.Polyline.AntPath(intersukun,options3);
        var path4 = new L.Polyline.AntPath(interkedun,options4);
        var path5 = new L.Polyline.AntPath(interpakis,options5);
        var path6 = new L.Polyline.AntPath(interkloje,options6);
        var path7 = new L.Polyline.AntPath(interlawan,options7);
        var path8 = new L.Polyline.AntPath(interkaran,options8);
        var path9 = new L.Polyline.AntPath(interdau  ,options9);
        var path10 =new L.Polyline.AntPath(interjabun,options10);

        var path11 =new L.Polyline.AntPath(interwagir,options11); 
        var path12 =new L.Polyline.AntPath(interpakji,options12);
        var path13 =new L.Polyline.AntPath(interbatu, options13);  
        var path14 =new L.Polyline.AntPath(intertumpa,options14); 
        var path15 =new L.Polyline.AntPath(interponco,options15); 
        var path16 =new L.Polyline.AntPath(interjunre,options16); 
        var path17 =new L.Polyline.AntPath(interpanje,options17); 
        var path18 =new L.Polyline.AntPath(interbulul,options18); 
        var path19 =new L.Polyline.AntPath(interturen,options19); 
        var path20 =new L.Polyline.AntPath(interdampi,options20); 

        var path21 =new L.Polyline.AntPath(interbumia,options21); 
        var path22 =new L.Polyline.AntPath(interpujon,options22); 
        var path23 =new L.Polyline.AntPath(interwajak,options23); 
        var path24 =new L.Polyline.AntPath(intergonda,options24); 
        var path25 =new L.Polyline.AntPath(intertajin,options25); 
        var path26 =new L.Polyline.AntPath(interpagel,options26); 
        var path27 =new L.Polyline.AntPath(intersumbe,options27); 
        var path28 =new L.Polyline.AntPath(interngaju,options28); 
        var path29 =new L.Polyline.AntPath(interpucun,options29);
        var path30 =new L.Polyline.AntPath(interbantu,options30);
        var path31 =new L.Polyline.AntPath(interngant,options31); 
        var path32 =new L.Polyline.AntPath(interkalip,options32);
        var path33 =new L.Polyline.AntPath(intertirto,options33);
        var path34 =new L.Polyline.AntPath(intergedan,options34);
        var path35 =new L.Polyline.AntPath(interwonos,options35);
        var path36 =new L.Polyline.AntPath(interkrome,options36);
        var path37 =new L.Polyline.AntPath(interpagak,options37);
        var path38 =new L.Polyline.AntPath(interdonom,options38);
        var path39 =new L.Polyline.AntPath(interampel,options39);
        var path40 =new L.Polyline.AntPath(interkasem,options40);
        
        path1.bindPopup("1.<br> Blimbing-Lowokwaru          <br> nilai:6215929,689").addTo(itensitasblimbing);
        path2.bindPopup("2.<br> Blimbing-Singosari          <br> nilai:5262376,545").addTo(itensitasblimbing);
        path3.bindPopup("3.<br> Blimbing-Sukun              <br> nilai:3441497,625").addTo(itensitasblimbing);
        path4.bindPopup("4.<br> Blimbing-Kedungkandang      <br> nilai:3178197,871").addTo(itensitasblimbing);
        path5.bindPopup("5.<br> Blimbing-Pakis              <br> nilai:3009460,814").addTo(itensitasblimbing);
        path6.bindPopup("6.<br> Blimbing-Klojen             <br> nilai:1972360,353").addTo(itensitasblimbing);
        path7.bindPopup("7.<br> Blimbing-Lawang             <br> nilai:1731812,989").addTo(itensitasblimbing);
        path8.bindPopup("8.<br> Blimbing-Karangploso        <br> nilai:1375702,847").addTo(itensitasblimbing);
        path9.bindPopup("9.<br> Blimbing-Dau                <br> nilai:1303587,376").addTo(itensitasblimbing);
        path10.bindPopup("10.<br>Blimbing-Jabung            <br> nilai:1117185,026").addTo(itensitasblimbing);

        path11.bindPopup("11.<br> Blimbing-wagir            <br> nilai:1011622,312").addTo(itensitasblimbing);
        path12.bindPopup("12.<br> Blimbing-Pakisaji         <br> nilai:981815,5472").addTo(itensitasblimbing);
        path13.bindPopup("13.<br> Blimbing-Batu             <br> nilai:965666,8225").addTo(itensitasblimbing);
        path14.bindPopup("14.<br> Blimbing-Tumpang          <br> nilai:726032,4456").addTo(itensitasblimbing);
        path15.bindPopup("15.<br> Blimbing-Poncokusumo      <br> nilai:667691,7979").addTo(itensitasblimbing);
        path16.bindPopup("16.<br> Blimbing-Junrejo          <br> nilai:656689,5265").addTo(itensitasblimbing);
        path17.bindPopup("17.<br> Blimbing-Kepanjen         <br> nilai:655399,2411").addTo(itensitasblimbing);
        path18.bindPopup("18.<br> Blimbing-Bululawang       <br> nilai:642271,9578").addTo(itensitasblimbing);
        path19.bindPopup("19.<br> Blimbing-Turen            <br> nilai:612855,4224").addTo(itensitasblimbing);
        path20.bindPopup("20.<br> Blimbing-Dampit           <br> nilai:509490,4375").addTo(itensitasblimbing);
            
        path21.bindPopup("21.<br> Blimbing-Bumiaji          <br> nilai:6215929,689").addTo(itensitasblimbing);
        path22.bindPopup("22.<br> Blimbing-Pujon            <br> nilai:5262376,545").addTo(itensitasblimbing);
        path23.bindPopup("23.<br> Blimbing-Wajak            <br> nilai:3441497,625").addTo(itensitasblimbing);
        path24.bindPopup("24.<br> Blimbing-Gondanglegi      <br> nilai:3178197,871").addTo(itensitasblimbing);
        path25.bindPopup("25.<br> Blimbing-Tajinan          <br> nilai:3009460,814").addTo(itensitasblimbing);
        path26.bindPopup("26.<br> Blimbing-Pagelaran        <br> nilai:1972360,353").addTo(itensitasblimbing);
        path27.bindPopup("27.<br> Blimbing-Sumbermanjing    <br> nilai:1731812,989").addTo(itensitasblimbing);
        path28.bindPopup("28.<br> Blimbing-Ngajum           <br> nilai:1375702,847").addTo(itensitasblimbing);
        path29.bindPopup("29.<br> Blimbing-Sumberpucung     <br> nilai:1303587,376").addTo(itensitasblimbing);
        path30.bindPopup("30.<br>Blimbing-Bantur            <br> nilai:1117185,026").addTo(itensitasblimbing);
        path31.bindPopup("31.<br> Blimbing-Ngantang         <br> nilai:6215929,689").addTo(itensitasblimbing);
        path32.bindPopup("32.<br> Blimbing-Kalipare         <br> nilai:5262376,545").addTo(itensitasblimbing);
        path33.bindPopup("33.<br> Blimbing-Tirtoyudo        <br> nilai:3441497,625").addTo(itensitasblimbing);
        path34.bindPopup("34.<br> Blimbing-Gedangan         <br> nilai:3178197,871").addTo(itensitasblimbing);
        path35.bindPopup("35.<br> Blimbing-Wonosari         <br> nilai:3009460,814").addTo(itensitasblimbing);
        path36.bindPopup("36.<br> Blimbing-Kromengan        <br> nilai:1972360,353").addTo(itensitasblimbing);
        path37.bindPopup("37.<br> Blimbing-Pagak            <br> nilai:1731812,989").addTo(itensitasblimbing);
        path38.bindPopup("38.<br> Blimbing-Donomulyo        <br> nilai:1375702,847").addTo(itensitasblimbing);
        path39.bindPopup("39.<br> Blimbing-Ampelgading      <br> nilai:1303587,376").addTo(itensitasblimbing);
        path40.bindPopup("40.<br> Blimbing-Kasembon         <br> nilai:1303587,376").addTo(itensitasblimbing);
        */
    ...
    /*kecamatan blimbing
        var interaksiblimbing=L.layerGroup();
        var kecblimbing=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_BLIMBING.geojson", {
        	    style :styleterbanyak
                }).bindPopup("kecamatan blimbing <br> jumlah penduduk : 182331 <br> jumlah kendaraan : 125626").addTo(interaksiblimbing);
        var keclowokwaru=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_LOWOKWARU.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan lowokwaru <br> jumlah penduduk : 163639 <br> jumlah kendaraan :128001").addTo(interaksiblimbing);
        var kecsingosari=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_SINGOSARI.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Singosari <br> jumlah penduduk : 190487 <br> jumlah kendaraan :59969").addTo(interaksiblimbing);
        var kecsukun=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_SUKUN.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan sukun <br> jumlah penduduk : 196300 <br> jumlah kendaraan :137352").addTo(interaksiblimbing);
        var keckedungkandang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KEDUNGKANDANG.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan kedungkandang <br> jumlah penduduk : 207428 <br> jumlah kendaraan :125626").addTo(interaksiblimbing);
        var kecpakis=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PAKIS.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Pakis <br> jumlah penduduk : 171657 <br> jumlah kendaraan :54041").addTo(interaksiblimbing);
        var kecklojen=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KLOJEN.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan klojen <br> jumlah penduduk : 94112 <br> jumlah kendaraan :75547").addTo(interaksiblimbing);        
        var keclawang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_LAWANG.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Lawang <br> jumlah penduduk : 114928 <br> jumlah kendaraan :36182").addTo(interaksiblimbing);
        var keckarang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KARANGPLOSO.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Karangploso <br> jumlah penduduk : 89032 <br> jumlah kendaraan :28029").addTo(interaksiblimbing);
        var kecdau=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_DAU.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Dau <br> jumlah penduduk : 82220 <br> jumlah kendaraan :25885").addTo(interaksiblimbing);                    
        var kecjabung=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_JABUNG.geojson", {
        	    style :style10besar
                }).bindPopup("kecamatan Jabung <br> jumlah penduduk : 75365 <br> jumlah kendaraan :23726").addTo(interaksiblimbing);
                
    
        var kecWagir=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_WAGIR.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Wagir <br> jumlah penduduk : 93211 <br> jumlah kendaraan :29345").addTo(interaksiblimbing);
        var kecPakisaji=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PAKISAJI.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Pakisaji <br> jumlah penduduk : 93157 <br> jumlah kendaraan :29328").addTo(interaksiblimbing);
        var kecBatu=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_BATU.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Batu <br> jumlah penduduk : 96921 <br> jumlah kendaraan :70609").addTo(interaksiblimbing);
        var kecTumpang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_TUMPANG.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Tumpang <br> jumlah penduduk : 75657 <br> jumlah kendaraan :23818").addTo(interaksiblimbing);
        var kecPoncokusumo=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PONCOKUSUMO.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Poncokusumo <br> jumlah penduduk : 92648 <br> jumlah kendaraan :29168").addTo(interaksiblimbing);
        var kecJunrejo=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_JUNREJO.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Junrejo <br> jumlah penduduk : 55105 <br> jumlah kendaraan :40145").addTo(interaksiblimbing);
        var kecKepanjen=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KEPANJEN.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Kepanjen <br> jumlah penduduk : 109634 <br> jumlah kendaraan :34515").addTo(interaksiblimbing);
        var kecBululawang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_BULULAWANG.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Bululawang <br> jumlah penduduk : 72917 <br> jumlah kendaraan :22956").addTo(interaksiblimbing);
        var kecTuren=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_TUREN.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Turen <br> jumlah penduduk : 115290 <br> jumlah kendaraan :36296").addTo(interaksiblimbing);
        var kecDampit=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_DAMPIT.geojson", {
        	    style :style20besar
                }).bindPopup("kecamatan Dampit <br> jumlah penduduk : 118479 <br> jumlah kendaraan :37300").addTo(interaksiblimbing);

        var kecBumiaji=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_BUMIAJI.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Bumiaji <br> jumlah penduduk : 61020 <br> jumlah kendaraan :44454").addTo(interaksiblimbing);
        var kecPujon=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PUJON.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Pujon <br> jumlah penduduk : 69040 <br> jumlah kendaraan :21735").addTo(interaksiblimbing);
        var kecWajak=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_WAJAK.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Wajak <br> jumlah penduduk : 81170 <br> jumlah kendaraan :25554").addTo(interaksiblimbing);
        var kecGondanglegi=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_GONDANGLEGI.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Gondanglegi <br> jumlah penduduk : 86796 <br> jumlah kendaraan :27325").addTo(interaksiblimbing);
        var kecTajinan=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_TAJINAN.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Tajinan <br> jumlah penduduk : 55119 <br> jumlah kendaraan :17353").addTo(interaksiblimbing);
        var kecPagelaran=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PAGELARAN.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Pagelaran <br> jumlah penduduk : 68147 <br> jumlah kendaraan :21454").addTo(interaksiblimbing);
        var kecSumbermanjing=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_SUMBERMANJINGWETAN.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Sumbermanjing <br> jumlah penduduk : 89928 <br> jumlah kendaraan :28311").addTo(interaksiblimbing);
        var kecNgajum=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_NGAJUM.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Ngajum <br> jumlah penduduk : 49504 <br> jumlah kendaraan :15585").addTo(interaksiblimbing);
        var kecSumberpucung=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_SUMBERPUCUNG.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Sumberpucung <br> jumlah penduduk : 55460 <br> jumlah kendaraan :17460").addTo(interaksiblimbing);
        var kecBantur=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_BANTUR.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Bantur <br> jumlah penduduk : 68824 <br> jumlah kendaraan :21667").addTo(interaksiblimbing);
        var kecNgantang=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_NGANTANG.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Ngantang <br> jumlah penduduk : 56376 <br> jumlah kendaraan :17748").addTo(interaksiblimbing);
        var kecKalipare=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KALIPARE.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Kalipare <br> jumlah penduduk : 59545 <br> jumlah kendaraan :18746").addTo(interaksiblimbing);
        var kecTirtoyudo=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_TIRTOYUDO.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Tirtoyudo <br> jumlah penduduk : 60928 <br> jumlah kendaraan :19181").addTo(interaksiblimbing);
        var kecGedangan=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_GEDANGAN.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Gedangan <br> jumlah penduduk : 53289 <br> jumlah kendaraan :16776").addTo(interaksiblimbing);
        var kecWonosari=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_WONOSARI.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Wonosari <br> jumlah penduduk : 41357 <br> jumlah kendaraan :13020").addTo(interaksiblimbing);
        var kecKromengan=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KROMENGAN.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Kromengan <br> jumlah penduduk : 38033 <br> jumlah kendaraan :11974").addTo(interaksiblimbing);
        var kecPagak=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_PAGAK.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Pagak <br> jumlah penduduk : 45597 <br> jumlah kendaraan :14355").addTo(interaksiblimbing);
        var kecDonomulyo=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_DONOMULYO.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Donomulyo <br> jumlah penduduk : 62585 <br> jumlah kendaraan :19703").addTo(interaksiblimbing);
        var kecAmpelgading=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_AMPELGADING.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Ampelgading <br> jumlah penduduk : 52000 <br> jumlah kendaraan :16371").addTo(interaksiblimbing);
        var kecKasembon=L.geoJSON.ajax("bahan/gskecamatan/Kecamatan_KASEMBON.geojson", {
        	    style :style30besar
                }).bindPopup("kecamatan Kasembon <br> jumlah penduduk : 31595 <br> jumlah kendaraan :9947").addTo(interaksiblimbing);
        */
